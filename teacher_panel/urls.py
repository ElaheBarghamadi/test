...
urlpatterns = [
    ...
    path('bank/folder/<int:folder_id>/import/', views.bank_folder_import, name='bank_folder_import'),
    path('bank/new/', views.bank_question_new, name='bank_question_new'),
    path('bank/<int:bank_id>/form/', views.bank_question_form, name='bank_question_form'),
    path('bank/seed-sample/', views.bank_seed_sample, name='bank_seed_sample'),
    path('bank/bulk/', views.bank_bulk_action, name='bank_bulk_action'),
